...
class ServerMessage(google.protobuf.message.Message):
    ...
    class FederatedPersonalizedEvaluateIns(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        class ConfigEntry(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
            KEY_FIELD_NUMBER: builtins.int
    ...
    FPE_INS_FIELD_NUMBER: builtins.int
    ...
    @property
    def fpe_ins(self) -> global___ServerMessage.FederatedPersonalizedEvaluateIns: ...
    ...
    def __init__(self,
        *,
        ...
        fpe_ins : typing.Optional[global___ServerMessage.FederatedPersonalizedEvaluateIns] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"fpe_ins",b"fpe_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"fpe_ins",b"fpe_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"reconnect",b"reconnect"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["reconnect","get_parameters","fit_ins","evaluate_ins","fpe_ins"]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    class FederatedPersonalizedEvaluateRes(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        BASELINE_FIELD_NUMBER: builtins.int
        PERSONALIZED_FIELD_NUMBER: builtins.int

        @property
        def baseline(self) -> global___ClientMessage.EvaluateRes: ...

        @property
        def personalized(self) -> global___ClientMessage.EvaluateRes: ...

        def __init__(self,
            *,
            baseline : typing.Optional[global___ClientMessage.EvaluateRes] = ...,
            personalized : typing.Optional[global___ClientMessage.EvaluateRes] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal[u"baseline",b"baseline",u"personalized",b"personalized"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"baseline",b"baseline",u"personalized",b"personalized"]) -> None: ...
    ...
    FPE_RES_FIELD_NUMBER: builtins.int
    ...
    @property
    def fpe_res(self) -> global___ClientMessage.FederatedPersonalizedEvaluateRes: ...
    ...
    def __init__(self,
        *,
        ...
        fpe_res : typing.Optional[global___ClientMessage.FederatedPersonalizedEvaluateRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"fpe_res",b"fpe_res",u"msg",b"msg",u"parameters_res",b"parameters_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"fpe_res",b"fpe_res",u"msg",b"msg",u"parameters_res",b"parameters_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","fpe_res"]: ...
